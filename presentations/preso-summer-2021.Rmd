...
## Season Stats - Team Results

## Season Stats - Notable Performances
...
```
- 1 vote - `r votes_wk$name[5]`
- 2 votes - `r votes_wk$name[4]`
- 3 votes - `r votes_wk$name[3]`
- 4 votes - `r votes_wk$name[2]`
- 5 votes - `r votes_wk$name[1]`


## Vote Count Match 1 - leaderboard

```{r}
votes_wk %>%
  select(name, cumulative) %>%
  rename(Votes = cumulative) %>%
  kable(digits = 1) 
