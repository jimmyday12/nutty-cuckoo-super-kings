...
batting_df %>%
  ...
  write_csv(here::here("presentations", "autumn-2021", "batting-stats-autumn-2021.csv"))

bowling_df %>%
  select(Name, Overs, Runs, Wkts, Econ, Avg, SR) %>%
  write_csv(here::here("presentations", "autumn-2021", "bowling-stats-autumn-2021.csv"))
...
fielding_df %>% 
  ...
  arrange(desc(Catches)) %>%
  write_csv(here::here("presentations", "autumn-2021", "fielding-stats-autumn-2021.csv"))

keeping_df %>%
  ungroup() %>%
  select(Name, Catches, Stumpings, Byes) %>%
  write_csv(here::here("presentations", "autumn-2021", "keeping-stats-autumn-2021.csv"))
...
match_details %>%
  ...
  write_csv(here::here("presentations", "autumn-2021", "summary-stats-autumn-2021.csv"))
