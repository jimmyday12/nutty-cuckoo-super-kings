...
google_app <- httr::oauth_app(appname = "my-google-app", 
...
# Get data ---------------------------------------------------------------------
url <- "https://docs.google.com/spreadsheets/d/16jQY6yRpaGuzzN7Gq1Gn21230qkTS3p6O7GCYBjjaEU/edit#gid=1779131739"
...
write_csv(dat_summary, file = "/Users/jamesday/R/nutty-cuckoo-super-kings/data/votes-summer-2021.csv")
